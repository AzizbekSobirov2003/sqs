...
import IntegrationNotistack2 from "@/components/snicBack2";
import Srav from "./srav";
...
<Srav/>
            ...
            <button className="mx-1 active:border active:bg-gray-100">
              {/* <Like /> */}
              <IntegrationNotistack2 />

            </button>
          </div>
        </div>
        <div className="p-2">
          <h1 className="text-[36px] font-[500]">Ветеринарное оборудование</h1>
